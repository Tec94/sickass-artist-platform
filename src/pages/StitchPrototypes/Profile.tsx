...
<Link aria-label="Back to Dashboard" className="nav-fab flex items-center justify-center w-12 h-12 bg-vellum border border-ink rounded-sm shadow-sm transition-all hover:border-primary group cursor-pointer" to="/dashboard">
...
<div>
<h1 className="font-display font-semibold text-2xl tracking-tight text-ink uppercase">Profile</h1>
<p className="text-xs font-medium text-muted tracking-widest uppercase mt-1">Your Account</p>
</div>

<button aria-label="Close Panel" className="nav-fab w-10 h-10 flex items-center justify-center border border-transparent hover:border-ink rounded-sm transition-all" onClick={() => { setNextTransition('push-back'); window.location.href = '/dashboard'; }}>
...
<h2 className="font-display font-semibold text-lg leading-tight">LOBO_09</h2>
  ...
  <div className="space-y-6 animate-fade-in">
    <div className="space-y-4">
      <div className="flex items-center justify-between">
        <h3 className="text-xs font-bold uppercase tracking-widest text-ink flex items-center gap-2"><Flame size={14}/> Daily Quests</h3>
      ...
      <div className="p-4 border border-ink rounded-sm bg-ink text-vellum">
        <div className="flex justify-between items-end mb-4">
          <div>
            ...
            <span className="text-sm font-medium">Lobo Rank</span>
          </div>
...
{activeTab === 'redeem' && (
  <div className="space-y-6 animate-fade-in">
    ...
    <div className="space-y-4">
      <h3 className="text-xs font-bold uppercase tracking-widest text-ink mt-8">Rewards</h3>
          ...
          <div className="flex justify-between items-start">
            <div className="flex gap-3 items-center">
              ...
              <div>
                ...
                <span className="text-xs text-muted block mt-0.5">Avatar cosmetic (Req. Lobo Rank)</span>
              </div>
            </div>
...
{activeTab === 'settings' && (
  <div className="space-y-8 animate-fade-in">
    <div className="space-y-4">
      <h3 className="text-xs font-bold uppercase tracking-widest text-ink flex items-center gap-2"><User size={14}/> Display Name</h3>
      <div className="border-b border-ink/30 focus-within:border-primary transition-colors pb-2">
        <label className="font-label text-xs tracking-widest opacity-50 block mb-2">Username</label>
        <input className="w-full bg-transparent border-none focus:ring-0 p-0 font-medium text-lg text-ink" defaultValue="LOBO_09" type="text" />
      </div>
    </div>
    
    <div className="space-y-4">
      <h3 className="text-xs font-bold uppercase tracking-widest text-ink flex items-center gap-2"><Globe size={14}/> Language</h3>
      <div className="border border-ink/20 rounded-sm overflow-hidden flex flex-col">
        ...
        <label className="flex items-center justify-between p-3 border-b border-ink/10 hover:bg-background-light/50 transition-colors cursor-pointer group">
          <span className="text-sm font-medium text-muted group-hover:text-ink">Español</span>
        ...
        <label className="flex items-center justify-between p-3 hover:bg-background-light/50 transition-colors cursor-pointer group">
          <span className="text-sm font-medium text-muted group-hover:text-ink">Português</span>
          <div className="w-4 h-4 rounded-full border-2 border-ink/20 group-hover:border-ink"></div>
        </label>
      </div>
    </div>
    ...
    <div className="space-y-4">
      <h3 className="text-xs font-bold uppercase tracking-widest text-ink flex items-center gap-2"><Moon size={14}/> Appearance</h3>
