...
<main className="flex-1 pt-[72px] pb-24 flex justify-center w-full px-4 sm:px-6">

<div className="w-full max-w-[800px] flex flex-col pt-10 sm:pt-16">
...
<div onClick={() => { setNextTransition('push'); window.location.href = '/experience-albert'; }} className="group flex cursor-pointer flex-col gap-3 border-b border-ink px-4 py-4 transition-all-custom hover:rounded hover:bg-[#FCFBF9] sm:h-[80px] sm:flex-row sm:items-center sm:justify-between">
...
<div className="flex w-full justify-start sm:w-1/4 sm:justify-end">
...
<div className="group flex cursor-not-allowed flex-col gap-3 border-b border-ink px-4 py-4 transition-all-custom hover:rounded hover:bg-[#FCFBF9] sm:h-[80px] sm:flex-row sm:items-center sm:justify-between">
<div className="w-full sm:w-1/4">
<span className="text-sm font-bold uppercase tracking-widest text-muted">22 Sep</span>
</div>
<div className="flex-1 text-left opacity-60 sm:text-center">
...
<div className="group flex cursor-pointer flex-col gap-3 border-b border-ink px-4 py-4 transition-all-custom hover:rounded hover:bg-[#FCFBF9] sm:h-[80px] sm:flex-row sm:items-center sm:justify-between">
<div className="w-full sm:w-1/4">
...
<div className="group flex flex-col gap-3 border-b border-ink px-4 py-4 transition-all-custom hover:rounded hover:bg-[#FCFBF9] sm:h-[80px] sm:flex-row sm:items-center sm:justify-between">
<div className="w-full sm:w-1/4">
