        ...
        <main className="flex flex-1 w-full max-w-[1440px] mx-auto">
            ...
            <section className="flex-1 flex flex-col bg-[#FAF7F2] min-h-[calc(100vh-72px)]">
                ...
                <div className="flex flex-col">
                    {/* Pinned Thread 1 */}
                    <Link to="/new-post" onClick={() => setNextTransition('push')} className="group relative flex items-center justify-between px-10 py-8 border-b border-[#3C2A21]/15 bg-[#FAF7F2] hover:bg-[#F4EFE6] transition-colors cursor-pointer">
