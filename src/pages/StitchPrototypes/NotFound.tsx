    ...
    <div className="flex min-h-[100dvh] flex-col overflow-hidden bg-[var(--site-page-bg)] text-[var(--site-text)] antialiased">
      ...
      <main className="flex-1 min-h-0">
        <section className="relative h-full overflow-hidden">
          ...
          <div className="relative flex h-full flex-col justify-center p-4 sm:p-8 md:p-10">
            <div className="max-w-[760px] border border-[#FAF7F2]/16 bg-[#1C1B1A]/22 p-5 shadow-[0_24px_60px_rgba(14,15,19,0.22)] backdrop-blur-md sm:p-8">
              ...
              <div className="mt-8 flex flex-col gap-4 sm:flex-row sm:flex-wrap">
                <Link
                  ...
                  className="inline-flex items-center justify-center border border-[#FAF7F2] px-7 py-3 text-center text-xs font-semibold uppercase tracking-[0.28em] text-[#FAF7F2] transition-colors hover:bg-[#FAF7F2] hover:text-[#3C2A21]"
                >
                  Return To Journey
                </Link>
                <Link
                  to="/dashboard"
                  onClick={() => setNextTransition('push')}
                  className="inline-flex items-center justify-center border border-[#FAF7F2]/35 bg-[#FAF7F2]/10 px-7 py-3 text-center text-xs font-semibold uppercase tracking-[0.28em] text-[#FAF7F2] transition-colors hover:border-[#FAF7F2] hover:bg-[#FAF7F2]/16"
                >
                  Open Dashboard
                </Link>
              </div>
