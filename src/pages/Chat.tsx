...
export function Chat() {
  ...
  return (
    <div className="chat-layout flex h-[calc(100vh-theme(spacing.16))] w-full bg-zinc-950 text-zinc-200 font-sans selection:bg-red-900/30 overflow-hidden">
      {/* Channel Sidebar */}
      <aside className="w-64 flex flex-col bg-zinc-950 overflow-hidden border-r border-zinc-800">
        <header className="h-16 px-4 flex items-center border-b border-zinc-800 shadow-sm cursor-pointer hover:bg-zinc-900 transition-colors">
          <h2 className="text-white font-bold font-display tracking-wide">{t('chat.serverName')}</h2>
        ...
        <section className="p-3 bg-zinc-950/50 border-t border-zinc-800 flex items-center gap-2">
           ...
           <div className="flex-1 min-w-0">
             ...
             <div className="text-zinc-500 text-[10px]">{t('common.online')}</div>
           </div>
      ...
      <main className="flex-1 flex flex-col bg-zinc-900 min-w-0">
        {selectedChannelId ? (
          ...
          <div className="flex-1 flex flex-col items-center justify-center text-zinc-500 p-8 text-center">
             ...
             <h3 className="text-white text-lg font-bold mb-1">{t('chat.welcomeTitle')}</h3>
